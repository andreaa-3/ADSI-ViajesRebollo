...
@Entity
@Table(name = "Users")
public class User { // Es una entidad. Genera las tablas
    ...
    private Role role; // Atriburo role que no es un string si no otra entidad. No aparece el id de la entidad si no la entidad tal cual (internamente sí que es cf).
